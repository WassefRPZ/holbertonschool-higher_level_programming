...
- créer un carré via une méthode de classe.
"""


class Rectangle:
    """
    Classe Rectangle avec fonctionnalités complètes.
    ...
    - Affichage personnalisé avec print_symbol
    - Méthode statique pour comparer deux rectangles par aire
    - Méthode de classe pour créer un carré (width = height)
    - Méthodes spéciales : __str__, __repr__, __del__
    """
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            Rectangle: le plus grand, ou rect_1 si égalité
    ...
    def square(cls, size=0):
        """
        Crée un carré (width = height = size).

        Args:
            size (int, optional): taille du côté (défaut 0)

        Returns:
            Rectangle: une instance avec largeur et hauteur égales
        """
