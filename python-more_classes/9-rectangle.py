...
class Rectangle:
    ...
    def __str__(self):
        ...
        if self.__width == 0 or self.__height == 0:
            ...
            for _ in range(self.__height):
                lignes.append(str(self.print_symbol) * self.__width)
            return "\n".join(lignes)
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            Le rectangle ayant la plus grande aire, ou rect_1 si égalité.
        """
    ...
    def square(cls, size=0):
        """
        Crée et retourne une nouvelle instance de Rectangle carrée.

        Args:
            size (int): Taille du côté du carré (largeur = hauteur = size).

        Returns:
            Une nouvelle instance de Rectangle avec width == height == size.
        """
